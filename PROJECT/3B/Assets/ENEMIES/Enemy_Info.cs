    ...
    void Update()
    {
        if (health <= 0)
        {
            ...
            if (rewardSpawned == false)
            {
                ...
                goldReward.GetComponent<UI_reward>().superBossReward = GetComponentInChildren<Enemy_Shooting>().superBoss;
                goldReward.GetComponent<UI_reward>().bossReward = GetComponentInChildren<Enemy_Shooting>().boss;
